...
try {
    ...
    console.log("🌍 Connected to the VISHWA-MD DB")
} catch {
...
let cc = Config.sessionName.replace(/vishwa;;;/g, "");
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "/assets/vmLogo.png"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "/assets/vmLogo.png"); //ur logo pic
